...
namespace :guest do
  ...
  task sample_data: :environment do
    ...
    puts "物品を作成中..."
    items_data = [
      { name: 'ノートパソコン', description: 'ビジネス用ノートパソコン', category: created_categories[0], location: created_locations[0], supplier: created_suppliers[0], stock_quantity: 5, min_stock: 2, unit: '台' },
      { name: 'ボールペン', description: '黒色ボールペン', category: created_categories[1], location: created_locations[1], supplier: created_suppliers[1], stock_quantity: 50, min_stock: 10, unit: '本' },
      { name: 'デスク', description: 'オフィス用デスク', category: created_categories[2], location: created_locations[2], supplier: created_suppliers[2], stock_quantity: 3, min_stock: 1, unit: '台' },
      { name: 'マウス', description: 'USBマウス', category: created_categories[0], location: created_locations[0], supplier: created_suppliers[0], stock_quantity: 8, min_stock: 3, unit: '個' },
      { name: 'コピー用紙', description: 'A4コピー用紙', category: created_categories[1], location: created_locations[1], supplier: created_suppliers[1], stock_quantity: 20, min_stock: 5, unit: '束' }
    ]
